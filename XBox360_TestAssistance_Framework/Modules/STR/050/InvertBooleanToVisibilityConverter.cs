...
namespace STR050
{
    ...
    /// If false, visibility will be Visible, if true, visibility will be Collapsed
    /// </summary>
    ...
    public class InvertBooleanToVisibilityConverter : IValueConverter
    {
        ...
        /// <summary>
        /// Converts a visibility back to a boolean
        /// If Visible the boolean will be false, otherwise the boolean will be true
        /// </summary>
        /// <param name="value">Value to convert</param>
        /// <param name="targetType">Type of value passed in value argument</param>
        /// <param name="parameter">An optional conversion parameter</param>
