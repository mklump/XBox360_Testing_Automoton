// -----------------------------------------------------------------------
// <copyright file="InvertHasDebugOutputSymbolsConverter.cs" company="Microsoft">
...
namespace CAT
{
    ...
    /// </summary>
    internal class InvertHasDebugOutputSymbolsConverter : IMultiValueConverter
    {
        /// <summary>
        /// Converts 2 booleans to a visibility
        /// </summary>
        ...
        public object Convert(object[] value, Type targetType, object parameter, CultureInfo language)
        {
            ...
            return (hasSymbolsA || hasSymbolsW) ? Visibility.Collapsed : Visibility.Visible;
        }
