// -----------------------------------------------------------------------
// <copyright file="HtmlLexicalAnalyzer.cs" company="Microsoft">
...
namespace HtmlToXamlConvert
{
    ...
    internal class HtmlLexicalAnalyzer : IDisposable
    {
        ...
        /// <summary>
        /// Whether or not to ignore the next white space
        /// </summary>
        private bool ignoreNextWhitespace;

        /// <summary>
        /// Whether or not the next character is an entity
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the next character denotes the end of the stream
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the next character is a tag start
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the next character is a tag end
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the next character is at a directive start
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the next character is an entity
        /// </summary>
        private bool IsNextCharacterEntity
        {
        ...
        public void Dispose()
        {
            if (this.inputStringReader != null)
            {
                this.inputStringReader.Dispose();
            }
        }
        ...
        /// <summary>
        /// Reads the look ahead character
        /// </summary>
        ...
        private void ReadUnknownDirective()
        {
            ...
            Debug.Assert(this.previousCharacter == '<' && this.nextCharacter == '!' && !(this.lookAheadCharacter == '-' || this.lookAheadCharacter == '['), "HtmlToXamlConverter");
        ...
        private void SkipProcessingDirective()
        {
            ...
            Debug.Assert(this.nextCharacter == '<' && this.lookAheadCharacter == '?', "HtmlToXamlConverter");
