// -----------------------------------------------------------------------
// <copyright file="HtmlFromXamlConverter.cs" company="Microsoft">
...
namespace HtmlToXamlConvert
{
    ...
    /// <summary>
    /// A static class that takes an XAML string
    ...
    public static class HtmlFromXamlConverter
    {
        ...
        {
            Debug.Assert(xamlReader.NodeType == XmlNodeType.Element, "HtmlToXamlConverter");
        ...
        /// <returns>new color string</returns>
        ...
        /// <summary>
        /// Parse XAML Thickness
        /// </summary>
        /// <param name="thickness">Thickness string</param>
        /// <returns>new thickness string</returns>
        ...
        private static void WriteElementContent(XmlTextReader xamlReader, XmlTextWriter htmlWriter, StringBuilder inlineStyle)
        {
            ...
            else
            {
                while (ReadNextToken(xamlReader) && xamlReader.NodeType != XmlNodeType.EndElement)
                {
                    switch (xamlReader.NodeType)
                    {
                        case XmlNodeType.Element:
                            ...
                            Debug.Assert(xamlReader.NodeType == XmlNodeType.EndElement || (xamlReader.NodeType == XmlNodeType.Element && xamlReader.IsEmptyElement), "HtmlToXamlConverter");
                            break;
                ...
                Debug.Assert(xamlReader.NodeType == XmlNodeType.EndElement, "HtmlToXamlConverter");
            }
        }
        ...
        /// <summary>
        /// Reads several items from XAML reader skipping all non-significant stuff.
        /// </summary>
        /// <param name="xamlReader">
